                ...
                <table className="min-w-full divide-y divide-gray-200">
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    {phases.map((phase, index) => <tr key={index}>
                        ...
                        <td className="px-4 py-3 whitespace-nowrap">
                          <input type="number" min="0" className="w-20 py-1 px-2 border border-gray-300 rounded-md text-sm" value={phase.quantity} onChange={e => handleQuantityChange(index, parseInt(e.target.value) || 0)} />
                        </td>
                        <td className="px-4 py-3 whitespace-nowrap text-sm">
