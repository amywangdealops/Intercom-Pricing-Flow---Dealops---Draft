...
import { ArrowRight, RefreshCw, ExternalLink, Plus, ChevronRight, Clock, Building2, Truck, Globe, DollarSign, CalendarDays, BarChart3, Check, X, FileText, Headphones, Users, Settings, MessageSquare } from 'lucide-react';
...
export function OpportunityPage() {
  ...
  return <div className="w-full bg-white" style={fontStyle}>
      ...
      <div className="p-5">
        ...
        <div className="grid grid-cols-2 gap-5 mb-5">
          ...
          <div className="border border-gray-200 rounded-md overflow-hidden">
            ...
            {existingQuotes.length === 0 ? <div className="p-6 flex flex-col items-center justify-center text-center h-48">
                ...
                {existingQuotes.map(quote => <div key={quote.id} className="flex items-center px-4 py-2.5 hover:bg-gray-50">
      ...
      {/* Compare Drawer */}
      <CompareDrawer isOpen={showCompareDrawer} onClose={() => setShowCompareDrawer(false)} selectedQuotes={selectedQuotes} quotes={existingQuotes} viewMode={compareViewMode} onViewModeChange={setCompareViewMode} />
    </div>;
}